'''
Project      : 
FilePath     : /DevelopPlatform-v2/dpagent/utils/tester/testDebugSolution.py
Descripttion : 
Author       : GDDG08
...
"""
usage:
from dpagent.utils.tester.testDebugSolution import TEST_LOG
...
import json
import datetime
logfile = f'./testDebugSolution.log'
...
nodeInput = {
    'retrieve_knowledge_code': ['buggy_code', 'analysis_buggy_code'],
    'retrieve_knowledge_doc': ['buggy_code', 'analysis_buggy_code'],
    'retrieve_knowledge_traj': ['buggy_code', 'analysis_buggy_code', 'error_msg', 'log_info', 'analysis_agent_output'],
    'reasoning': ['buggy_code', 'analysis_buggy_code', 'knowledge_code', 'knowledge_doc', 'knowledge_traj'],
    'reasoning2': ['buggy_code', 'code_fix_step'],
    'functionality_retrieve': ['code_fix'],
    'functionality': ['code_fix', 'code_fix_retrieve_feedback'],
    'formulation': ['code_fix', 'code_fix_analysis', 'buggy_code', 'analysis_buggy_code'],
    'implementation': ['buggy_code', 'root_cause', 'correction_strategy'],
}
