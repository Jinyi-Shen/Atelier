'''
Project      : 
FilePath     : /DevelopPlatform-v2/dpagent/utils/tester/testActionSeqMaker.py
Descripttion : 
Author       : GDDG08
...
"""
usage:
from dpagent.utils.tester.testActionSeqMaker import TEST_LOG
...
logfile = f'./testActionSeqMaker.log'
